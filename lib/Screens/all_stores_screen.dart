...
/*  final categoryName;
  ...
  @override
  _AllStoresPage createState() => _AllStoresPage();
}

class _AllStoresPage extends State<AllStoresPage> {
                          ...
                          ListTile(
                              title:        Container(
                                ...
                                child: Text(storeList[index].name,style: TextStyle(
                                    color: Colors.black45,fontSize: 17,fontWeight: FontWeight.w900
                                ),
                              ...
                              subtitle:     Container(
                                ...
                                child: Text(storeList[index].location,style: TextStyle(
